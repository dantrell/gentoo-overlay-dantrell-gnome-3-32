...
src_prepare() {
	eapply "${FILESDIR}"/${PN}-3.32.4-gtk-doc-fix{1,2}.patch
	eapply "${FILESDIR}"/${PN}-3.32.5-webkitgtk-2.26-compat.patch # Don't use with 3.34, it should be compatible without this hack.
